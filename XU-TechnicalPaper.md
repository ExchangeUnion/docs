...
a) to elegantly get around channel volume restrictions

b) to elegantly increase volume when needed by simply opening new channels

c) achieve better connectivity (direct channels) between different XU nodes
