...
3. [Under the hood](#3-under-the-hood)  
  ...
  3.3. [Decentralized Orderbooks](#33-decentralized-order-book-（dob))  
...
**B)** Use Exchange Union directly with taking on full responsibility of operating an XU node
